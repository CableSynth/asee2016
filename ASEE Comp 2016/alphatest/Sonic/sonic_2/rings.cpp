...
void rings::dropRings() {
    ...
    (stateCounter == 2 || stateCounter == 3 || stateCounter == 7 || stateCounter == 8 || stateCounter == 10
    || stateCounter == 20 || stateCounter == 21 || stateCounter == 23 || stateCounter == 24 || stateCounter == 28 || stateCounter ==29 )){
      dropCounter++;
      dropRing();
    }
