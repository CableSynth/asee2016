...
//const int SENSOR_ANGLES[15] = {5, 4, 3, 2, 2, 1, 0, 0, 0, -1, -2, -2, -3, -4, -5}; // REVERSED
...
enum State { LINE_FOLLOW, LEFT_TURN1, LEFT_TURN2, RIGHT_TURN1, RIGHT_TURN2, IGNORE_TURN,LAND_PLANE, OFF_TRACK, ON_WALL, ON_TRACK, POST_DROP, WALL_FOLLOW_R, WALL_FOLLOW_L, MIDDLE_AREA1, MIDDLE_AREA2, EDGE_AREA, OFF_WALL };
