...
void rings::dropRings() {
    ...
    (stateCounter == 2 || stateCounter == 3 || stateCounter == 5 || stateCounter == 6 || stateCounter == 8 || stateCounter == 9
    || stateCounter == 13 || stateCounter == 14 || stateCounter == 16 || stateCounter == 17 )){
      dropCounter++;
      dropRing();
    }
