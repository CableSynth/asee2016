...
#define RING_DISPENSER_R2 12 //IR Interuptor that sees the slot in the gear

//PWM
#define RING_DISPENSER_SERVO 10 //Arm swinger
#define STEERING_MIDDLE   9 //Steering Servo

#define RING_DISPENSER_R1 13 //Not used
#define RING_DISPENSER_L1 11 //Not used
#define RING_CHUTE_R      5 //Not used
#define RING_CHUTE_L      4 //Not used
