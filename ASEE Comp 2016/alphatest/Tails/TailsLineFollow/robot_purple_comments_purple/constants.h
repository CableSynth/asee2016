...
enum State {LINE_FOLLOW, LEFT_TURN1, LEFT_TURN2, RIGHT_TURN1, RIGHT_TURN2, RIGHT_TURN3, 
              OFF_WALL, ON_WALL, WALL_FOLLOW_R, WALL_FOLLOW_L, MIDDLE_AREA1, MIDDLE_AREA2, 
              LINE_FOLLOW_UNTIL_XING, EDGE_AREA, FOLLOW_TILL_LOSE, FOLLOW_TIME, FOLLOW_TIME_SHORT, 
              WALL_UNTIL_LOSE, GENTLE_RT, GENTLE_RT2, GENTLE_LT, GENTLE_LT_2, PRE_PARK, PARK, STOP, 
              STRAIGHTtoWALL, LEFT_TURN_MAX, BACK_UP };

//_NEW
const int stateMap[23] = {
LINE_FOLLOW_UNTIL_XING, STOP, RIGHT_TURN1, RIGHT_TURN2, 
LINE_FOLLOW_UNTIL_XING, RIGHT_TURN1, RIGHT_TURN2, 
LINE_FOLLOW_UNTIL_XING, RIGHT_TURN1, RIGHT_TURN2, STRAIGHTtoWALL,  
GENTLE_LT, LINE_FOLLOW_UNTIL_XING, RIGHT_TURN1, RIGHT_TURN2, 
LINE_FOLLOW_UNTIL_XING, RIGHT_TURN1, RIGHT_TURN2, 
GENTLE_RT2, FOLLOW_TIME, PRE_PARK, PARK, BACK_UP };
