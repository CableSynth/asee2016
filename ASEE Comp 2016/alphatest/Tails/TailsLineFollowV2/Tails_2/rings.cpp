...
void rings::dropRings() {
    ...
    (stateCounter == 7 || stateCounter == 8 || stateCounter == 14 || stateCounter == 15
    || stateCounter == 16 || stateCounter == 17 || stateCounter == 19 || stateCounter == 20 || stateCounter == 22 ||
    stateCounter == 23 || stateCounter == 34 || stateCounter == 44 )){
      dropCounter++;
      dropRing();
    }
