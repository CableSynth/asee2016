    ...
    switch (stateMap[stateCounter]) {
        ...
        driveSpeed = SPEED;
            ...
            if (index == -1) {
                ...
                //if its the first line follow till xing turn left to find line else turn right to find line
              if(stateCounter < 15){
