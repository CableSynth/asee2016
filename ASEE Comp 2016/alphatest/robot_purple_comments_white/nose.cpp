...
int nose::getAngle() {
    ...
    switch (currentState) {
        ...
        case WALL_FOLLOW_R:
            ...
            } else if (pathCounter == 6 && wall_RS < 100 && wall_R < 100) {
        ...
        case WALL_FOLLOW_L:
            ...
            if (wall_RS > DIST_START_TURN && pathCounter != 9) {
                ...
                // lost wall after delivering last ring; go stop in finish
                dropRing();
        ...
        case LINE_FOLLOW:
            if (pathCounter == 4 && amountSeen > 2) {
                ...
                setNose(NOSE_CENTER - 10);
                while(analogRead(WALL_SENSOR_R) < 200);
                ++pathCounter;
            }
            break;
    ...
    switch (currentState) {
        ...
        // follow the left wall
        case WALL_FOLLOW_L:
                angle = NOSE_CENTER + (WALL_DIST - wall_L)/40;
