...
PARK, STOP, STRAIGHTtoWALL, LEFT_TURN_MAX, BACK_UP, TURN_TO_LINE, BACK_UP_STRAIGHT, RT_TO_WALL, LT_TO_LINE };

//_NEW
const int stateMap[34] = { 
RT_TO_WALL, LT_TO_LINE, LINE_FOLLOW, LEFT_TURN1,  LEFT_TURN2,//FIRST BOX_2
...
LINE_FOLLOW, FOLLOW_TIME_SHORT, STOP };
