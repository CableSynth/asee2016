...
const int TILL_TURN = 290000;
const int TURN = 530000;
const int AFTER_TURN = 600000;
...
const bool RING_DROPS[PATH_LENGTH] = {true, false, true, true, false, false, true, false, true, false,false};
